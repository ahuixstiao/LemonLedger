<template>
  <div class="employee-container">
    ...
    <el-dialog v-model="data.editEmployeeDialogVisible" title="添加员工" width="40%" center>
      <el-form
        ref="employeeFormRef"
      ...
      <template #footer>
        ...
        <el-button type="primary" @click="validateEmployeeForm(employeeFormRef)">新增</el-button>
      </template>
    </el-dialog>
  </div>
</template>
...
import { queryAdminEmployeeList, saveAdminEmployee } from '../../../network/admin/index.js'
