...
) ENGINE=InnoDB AUTO_INCREMENT=13 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='员工表';
...
) ENGINE=InnoDB AUTO_INCREMENT=81 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='成衣厂表';
...
CREATE TABLE `factory_bill` (
  ...
  `quotation_id` int NOT NULL COMMENT '报价ID，关联factory_quotation.id',
  ...
  KEY `factory_bill_quotation_index` (`quotation_id`)
) ENGINE=InnoDB AUTO_INCREMENT=2883 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='成衣厂账单表';

-- ----------------------------
-- Table structure for factory_job_category
-- ----------------------------
DROP TABLE IF EXISTS `factory_job_category`;
CREATE TABLE `factory_job_category` (
  `id` int NOT NULL AUTO_INCREMENT COMMENT '主键',
  `category` varchar(32) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NOT NULL COMMENT '工作类型，例如前袋、后袋、前后袋、裤头、裤页',
  `version` int DEFAULT NULL COMMENT '乐观锁',
  `created_date` date DEFAULT NULL COMMENT '创建时间',
  `flag` tinyint(1) NOT NULL DEFAULT '0' COMMENT '删除状态 0否 1是',
  `remark` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci DEFAULT NULL COMMENT '备注',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=7 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='成衣厂工作类型表';
...
CREATE TABLE `factory_quotation` (
  ...
  `remark` varchar(255) DEFAULT NULL COMMENT '备注',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=273 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='成衣厂报价表';
...
CREATE TABLE `job` (
  ...
  `factory_id` int NOT NULL COMMENT '成衣厂ID',
  `number` varchar(32) NOT NULL COMMENT '床号',
  `style_number` varchar(32) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NOT NULL COMMENT '款式编号 比如3101',
  `mode_id` int NOT NULL COMMENT '工作方式，例如 压花、刮胶',
  `category_id` int NOT NULL COMMENT '工作类型，例如 小花、大花、裤页',
  `quantity` int NOT NULL COMMENT '数量',
  `work_order_id` bigint DEFAULT NULL COMMENT '关联工单ID（认领工单后写入）',
...
) ENGINE=InnoDB AUTO_INCREMENT=6406 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='工作内容表';
...
CREATE TABLE `job_category` (
  ...
  `remark` varchar(255) DEFAULT NULL COMMENT '备注',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=11 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='工作类型表';
...
) ENGINE=InnoDB AUTO_INCREMENT=15 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='工作报价表';

-- ----------------------------
-- Table structure for job_work_order
-- ----------------------------
...
CREATE TABLE `job_work_order` (
  ...
  `remark` varchar(255) DEFAULT NULL COMMENT '备注',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='工作工单表';
